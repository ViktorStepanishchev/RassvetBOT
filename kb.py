...
back_to_main_after_done_anketa_kb = [[InlineKeyboardButton(text=text.back, callback_data="back_to_main_after_done_anketa")]]
...
anketa_choice_kb = [[InlineKeyboardButton(text = text.view_anketa, callback_data="user_anketa"), InlineKeyboardButton(text = text.redacting_anketa, callback_data="edit_ank")]]
